...
describe("Animals unit tests", () => {
  it("should throw error when id is empty", () => {
    expect(() => {
      let animal = new Animal("", new Date(), TypeAnimal.COW, "1", "1");
  ...
  it("should throw error when dateOfBirth is empty", () => {
    expect(() => {
      let animal = new Animal("Animal", null as any, TypeAnimal.COW, "1", "1");
    }).toThrowError("Date of birth is required");
  });

  it("should throw error when name in changeName is empty", () => {
    let animal = new Animal("Animal", new Date(), TypeAnimal.COW, "1", "1");
