...
export interface MilkRepositoryInterface extends RepositoryInterface<MilkProduction> {
    addDailyMilkProduction(data: addDailyMilkProductionParams): Promise<any>;
    findDailyMilkProduction(idAnimal: string): Promise<MilkProduction[] | undefined>;
